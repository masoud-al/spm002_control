...
#				PyTango.Except.throw_exception('Could not open device.',
#											''.join(('Could not open device ', str(self.Serial), str(e)))
#											, 'initSpectrometer', sever=PyTango.ErrSeverity.ERR)
...
#			print 'Calc spec data:'
#			print 'Peak ind:', peakInd, self.spectrumCenter
#			print 'Half max:', halfMax
#			print 'Half ind:', halfInd, halfIndReduced, self.wavelengths[halfIndReduced]
...
#		except Exception, e:
#			self.set_state(PyTango.DevState.FAULT)
#			self.set_status(''.join(('Could not close device', str(e))))
#			self.error_stream(''.join(('Could not close device', str(e))))
